 ...
 * 
 * Versión con carga de variables de entorno desde .env.local
 */
...
async function migrateTestTypes() {
  ...
  console.log('3. Cambia CONFIRMED = false a true en este archivo');
  console.log('4. Ejecuta nuevamente: npx tsx scripts/migrate-with-env.ts');
  console.log('');
